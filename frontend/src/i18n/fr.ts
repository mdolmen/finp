...
export const fr = {
  ...
  tink: {
    ...
    reauthRequired: "Token Tink expiré. Cliquez sur « Connexion bancaire » pour vous reconnecter.",
    link: "Lier",
    linked: "Lié",
    linkTitle: "Lier un compte Tink — {name}",
    linkDescription: "Sélectionnez le compte Tink correspondant à ce compte.",
    linkFieldTinkAccount: "Compte Tink",
    linkNone: "— aucun —",
    linkSave: "Lier",
